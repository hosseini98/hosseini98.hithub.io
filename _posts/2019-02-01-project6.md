...
The "ZIP code" colum contains lots of signs and also exta letters attached to some of Zip codes in this colum. This function written below will strip all these out from the column.  
